function [points,t] = fnplotdense(f,varargin)
%% this code is a high-resolution version of fnplt, to ensure the resulting curve is displayed smoothly with lots of coils
